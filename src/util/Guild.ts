...
export async function logBlacklist(guildId: string, channelId: string, client: Bot) {
    try {
        let guild = await Guild.findById(guildId)
...
export async function logBan(guildId: string, channelId: string, client: Bot) {
    try {
        let guild = await Guild.findById(guildId)
...
export async function logVoice(guildId: string, channelId: string, client: Bot) {
    try {
        let guild = await Guild.findById(guildId)
...
export async function logMessageDelete(guildId: string, channelId: string, client: Bot) {
    try {
        let guild = await Guild.findById(guildId)
...
export async function logMessageEdit(guildId: string, channelId: string, client: Bot) {
    try {
        let guild = await Guild.findById(guildId)
